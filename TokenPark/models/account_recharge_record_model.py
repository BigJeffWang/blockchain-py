...
class AccountRechargeRecordModel(BaseModel):
    ...
    account_recharge_record_id = Column(String(32), unique=True, nullable=False, server_default="", default="", comment="记录id")
    ...
    token_address = Column(String(255), nullable=False, server_default="", default="", comment="我方收款地址")
    memo = Column(String(512), nullable=False, server_default="", default="", comment="memo")
    receive_token = Column(Numeric(36, 18), nullable=False, default=get_decimal('0.000000000000000000'), server_default=str(get_decimal('0.000000000000000000')), comment="应到账token,单位:eth")

...
class WalletBtcGatherModel(BaseModel):
    ...
    amount = Column(Numeric(21, 18), default=get_decimal('0', 18), nullable=False, server_default="0.000000000000000000", comment="可用余额")
    ...
    amount_frozen = Column(Numeric(21, 18), default=get_decimal('0', 18), nullable=False, server_default="0.000000000000000000", comment="已支付未确认到账(含手续费)")

...
class WalletEthGatherModel(BaseModel):
    __tablename__ = "wallet_eth_gather"
    ...
    amount = Column(Numeric(21, 18), default=get_decimal('0', 18), nullable=False, server_default="0.000000000000000000", comment="地址上的钱")

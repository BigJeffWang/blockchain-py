...
class WalletEosModel(BaseModel):
    __tablename__ = "wallet_eos"
    sub_index = Column(BigInteger, nullable=False, comment="子钱包索引")
    sub_public_address = Column(String(128), unique=True, nullable=False, server_default="", comment="子地址")
    ...
    amount = Column(Numeric(21, 18), default=get_decimal('0', 18), nullable=False, server_default="0.000000000000000000", comment="地址上的钱,单位是ether")
    amount_change = Column(Numeric(21, 18), default=get_decimal('0', 18), nullable=False, server_default="0.000000000000000000", comment="待找零金额")
    amount_frozen = Column(Numeric(21, 18), default=get_decimal('0', 18), nullable=False, server_default="0.000000000000000000", comment="已支付未确认到账")

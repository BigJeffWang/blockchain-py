...
class SecretEosGatherModel(BaseModel):
    __tablename__ = "secret_eos_gather"
    ...
    sub_private_key_aes = Column(String(255), nullable=False, server_default="", comment="归集账户 子私钥AES加密")
    sub_public_key_aes = Column(String(255), nullable=False, server_default="", comment="归集账户 子公钥AES加密")
